...
const sections = [
  ...
  { label: 'Team', desc: 'Executive, committee, advisors, alumni', path: '/admin/team', icon: Users, color: 'bg-purple-600' },
  { label: 'Blog Posts', desc: 'Create, edit, publish articles', path: '/admin/blog', icon: FileText, color: 'bg-amber-600' },
